...
import { Lock, User, Eye, EyeOff, Activity, ShieldQuestion } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-darkbg-base flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background blobs */}
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8 flex flex-col items-center justify-center">
          <div className="bg-brand-orange/15 p-3 rounded-2xl border border-brand-orange/40 mb-3 animate-bounce">
        ...
        <p className="text-[10px] text-center text-gray-500 font-semibold uppercase tracking-widest mt-6">
          Authorized personnel only. Logs generated automatically.
        </p>
      </div>
