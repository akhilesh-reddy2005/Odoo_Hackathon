...
import { BarChart3, TrendingUp, Sparkles, Wrench, ShieldAlert, Award } from 'lucide-react';
...
export default function Analytics() {
  ...
  const { monthlyTrips, monthlyExpenses, fuelConsumption, costlyVehicles, topDrivers, vehicleROI } = data;
